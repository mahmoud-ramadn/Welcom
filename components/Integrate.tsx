    ...
    return (
        <div className="relative flex h-[500px] w-full flex-col items-center justify-center">
            <div className="relative flex h-full w-full flex-row items-center justify-center overflow-hidden">
                <Marquee pauseOnHover vertical className="[--duration:15s] gap-4">
                    {firstRow.map((review) => (
    ...
    return (
        <div className="bg-[#F5F5F5] pb-10">
            <div className="container flex items-center md:flex-row flex-col gap-20">
                ...
                <div>
                    <h1 className="text-black lg:text-[121px] sm:text-[90px] text-5xl md:font-normal font-bold pb-2">
                        Integrate
                    </h1>
                    <h1 className="text-black md:text-[121px] text-5xl md:font-normal font-bold flex items-center gap-2">
                        <Image
                            src={integr}
                    ...
                    <p className="text-xl mt-5 text-black max-w-[505px] w-full pt-3">
